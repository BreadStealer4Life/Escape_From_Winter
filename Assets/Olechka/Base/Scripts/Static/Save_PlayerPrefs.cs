...
namespace Olechka
{
    ...
    public static class Save_PlayerPrefs
    {
        ...
        static void Initialization_saving()
        {
            ...
            Save_parameter(Type_parameter_value_float.Global_volume_sound, 1);
            Save_parameter(Type_parameter_value_float.Mouse_sensitivity, 1);
            Save_parameter(Type_parameter_bool.New_game, true);
            //
        ...
        public static void Save_parameter(Type_parameter_value_float _parameter, string _name, float _value)
        {

            string name = _parameter.ToString() + "_" + _name;
        ...
        public static void Save_parameter(Type_parameter_value_int _parameter, string _name, int _value)
        {
        ...
        public static float Know_parameter(Type_parameter_value_float _parameter, string _name_id)
        {
            if (!PlayerPrefs.HasKey(nameof(Initialization_saving_bool)))
                Initialization_saving();
        ...
        public static int Know_parameter(Type_parameter_value_int _parameter, string _name_id)
        {
            if (!PlayerPrefs.HasKey(nameof(Initialization_saving_bool)))
                Initialization_saving();
