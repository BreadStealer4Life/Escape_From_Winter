...
namespace Olechka
{
    [AddComponentMenu("Olechka scripts / General / Animation activation")]
    ...
    public class Animation_activation : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="_name_animation">Имя анимации</param>
        public void Play_force_animation(string _name_animation)
        {
            Anim.CrossFade(_name_animation, 0,0,0);
        }


        /// <summary>
        /// Запустить насильно нужную анимацию со сглаженным переходом
        /// </summary>
        /// <param name="_name_animation">Имя анимации</param>
        public void Play_CrossFade_animation(string _name_animation)
        {
            Anim.CrossFade(_name_animation, CrossFade_value, 0);
        }

        /// <summary>
        /// Установить степень сглаженного перехода
        /// </summary>
        /// <param name="_name_animation">название bool переменной</param>
        public void Set_CrossFade_value(float _value)
        {
            CrossFade_value = _value;
        }
