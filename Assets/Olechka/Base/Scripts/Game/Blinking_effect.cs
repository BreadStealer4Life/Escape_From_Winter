...
namespace Olechka
{
    [AddComponentMenu("Olechka scripts / Game / Battle / Blinking effect")]
    ...
    public class Blinking_effect : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                Material_body_array[x].material.color = Default_color_body_array[x];
            }
        }
        ...
        public void Activation()
        {
            ...
            if (Material_body_array.Length > 0 && gameObject.activeSelf)
            {
